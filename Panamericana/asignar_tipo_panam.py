...
for simbolo in simbolos:
    ...
    df['MARCAm'] = df['MARCAm'].str.replace(simbolo,'')
    df['MODELOm'] = df['MODELOm'].str.replace(simbolo,'')
    
    df_modelos['MODELO'] = df_modelos['MODELO'].str.replace(simbolo,'')
    df_modelos['MARCA'] = df_modelos['MARCA'].str.replace(simbolo,'')
